define(['hbs!../template/main.html',
    'i18n!../i18n/main',
    "../actions/mainAction",
    "gmms/main/views/SysMenuMainView",
    ...
    var IndexView = fish.View.extend({
        ...
        afterRender: function () {
            var that = this;
            var menu = { id: 'tabs-home',url:'gmms/main/views/SysMenuMainView'};
        ...
        updatePwrd:function () {
            fish.popupView({
                url: "modules/login/views/popwin/SysupdatePwdPopView",
                height : 200,
                width : 500,
                viewOption: {
        ...
        outLoginClick:function(){
            layer.confirm("确定退出?", function () {
                $.ajax({
                    type: "post",
                    url: "dbmm/LoginController/loginOut.do",
                    data: "json",
                    dataType:"json",
